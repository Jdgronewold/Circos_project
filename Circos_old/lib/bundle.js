...
/***/ function(module, exports, __webpack_require__) {
	...
	var handleData = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Circos = __webpack_require__(4);
	
	var loadLayout = exports.loadLayout = function loadLayout() {
	
	  if (!window.FileReader) {
	    return alert('FileReader API is not supported by your browser.');
	  }
	  var $i = $('#layout-file'),
	      // Put file input ID here
	...
	var loadData = exports.loadData = function loadData(trackName) {
	  if (!window.FileReader) {
	    return alert('FileReader API is not supported by your browser.');
	  }
	  var $i = $('#data-file'),
	...
	var parseLayout = exports.parseLayout = function parseLayout($obj, configObj) {
	
	  var data = Papa.parse($obj.html(), {
	    header: true,
	    dynamicTyping: true,
	    complete: function complete(results) {
	      console.log(results);
	      var circos = new Circos(results.data, configObj);
	      var instance = circos.buildInstance();
	      debugger;
	...
	var parseData = exports.parseData = function parseData($obj, configObj) {
	...
	var Circos = function () {
	  ...
	  _createClass(Circos, [{
	    ...
	    value: function buildInstance() {
	      return this.circos.layout(this.config, this.data);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objectify = function objectify(serializedArray) {
	  var obj = {};
	  $.each(serializedArray, function (idx, object) {
	    var value = void 0;
	...
	var clickEvents = function clickEvents() {
	  ...
	  $('#submit-layout').click(function (e) {
	
	    var configSerial = $('#layout-form').serializeArray();
	    var configData = objectify(configSerial);
	
	    var labelSerial = $('#labels-form').serializeArray();
	    var labelData = objectify(labelSerial);
	
	    var ticksSerial = $('#ticks-form').serializeArray();
	    var tickData = objectify(ticksSerial);
